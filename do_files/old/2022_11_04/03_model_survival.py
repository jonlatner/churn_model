...
## Lifespan of customers with different internet services
        ...
        kmf_no.fit(T[df['internet_service_no']== 1], event_observed=E[df['internet_service_no']== 1], label="No")
        ax=kmf_no.plot_survival_function()
        
        kmf_fiber = KaplanMeierFitter()
        kmf_fiber.fit(T[df['internet_service_fiber_optic']== 1], event_observed=E[df['internet_service_fiber_optic']== 1], label="Fiber optic")
        ax=kmf_fiber.plot_survival_function(ax=ax)
        
        kmf_dsl = KaplanMeierFitter()
        kmf_dsl.fit(T[df['internet_service_fiber_optic']== 0], event_observed=E[df['internet_service_fiber_optic']== 0], label="DSL")
        ax=kmf_dsl.plot_survival_function(ax=ax)
