...
pd.crosstab(df["paperless_billing"], df["payment_method"])
...
# Who are the missings
df_missing_check=df[df["total_charges"].isnull()]
df_missing_check
df_missing_check.nunique()

del(df_missing,df_graph,df_missing_check)
...
###########################
# Graph churn by contract charges (numeric)
###########################
